    ...
    <div className="rounded-2xl shadow-xl overflow-hidden transition-transform duration-300 hover:scale-[1.02]" >
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex flex-col lg:flex-row md:flex-row lg:flex md:flex  items-center justify-between mt-4">
          ...
          <div className="lg:flex lg:space-x-2 md:flex md:flex md:space-x-2 flex space-x-4 ">
            <button
            ...
            >
              ...
              <span className="lg:text-[14px] md:text-[14px] text-[6px]" onClick={()=>handleAddtoCart(product)} >Add to Cart</span>
            </button>
            <button
              onClick={toggleFavorite}
              className={`lg:p-2 md:p-0 lg:rounded-full rounded-full border ${
